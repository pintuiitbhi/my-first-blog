...
class Quiz(models.Model):
    ...
    url = models.SlugField(
        max_length=60, blank=False,default="test-test",
...
class Sitting(models.Model):
    ...
    question_list = models.IntegerField(
...
class Answer(models.Model):
    question = models.ForeignKey(MCQuestion, verbose_name="Question",on_delete=models.CASCADE)
