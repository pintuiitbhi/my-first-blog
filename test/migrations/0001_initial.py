# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-12-11 18:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='test.Category', verbose_name='Category')),
            ],
            options={
                'verbose_name': 'Quiz',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question_order', models.IntegerField(verbose_name='Question Order')),
                ('question_list', models.IntegerField(verbose_name='Question List')),
                ('incorrect_questions', models.IntegerField(blank=True, verbose_name='Incorrect questions')),
                ...
                ('quiz', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='test.Quiz', verbose_name='Quiz')),
        ...
        migrations.AddField(
            model_name='question',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='test.Category', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='question',
            name='quiz',
            field=models.ManyToManyField(blank=True, to='test.Quiz', verbose_name='Quiz'),
        ),
        migrations.AddField(
            model_name='question',
            name='sub_category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='test.SubCategory', verbose_name='Sub-Category'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='test.MCQuestion', verbose_name='Question'),
        ),
    ]
